...
<html>
    <head>
        <meta charset="utf-8">
        <title> Annuler un Reservations | Centre Omnisport Bel Air</title>
			...
			<h1>Liste Des Reservations</h1>
					...
					<table>
						...
						<c:forEach var="list" items="${sessionScope.list}">
							...
							<td><a href="AnnulerServlet?code=${list[0]}&jour=${list[1]}&heure=${list[2]}"><c:out value="Annuler"></c:out></a></td>
							</tr>
						</c:forEach>
					</table>
					</c:otherwise>

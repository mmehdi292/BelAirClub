...
/**
 * Servlet implementation class ConsulterListeReservationServlet
 */
@WebServlet("/ConsulterListeReservationServlet")
public class ConsulterListeReservationServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsulterListeReservationServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session.getAttribute("user") == null) {
			...
			RequestDispatcher dispatch = request.getRequestDispatcher("/WEB-INF/membre/ConsulterListeReservation.jsp");
			dispatch.forward(request, response);	
		}
	}
